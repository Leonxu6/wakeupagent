"""Detect logging.basicConfig() in reusable production modules."""
...
def audit_source(source: str)->list[str]:
    ...
    return [f"logging.basicConfig() mutates process-wide logging on line {n.lineno}" for n in ast.walk(tree) if isinstance(n,ast.Call) and isinstance(n.func,ast.Attribute) and isinstance(n.func.value,ast.Name) and n.func.value.id=="logging" and n.func.attr=="basicConfig"]
