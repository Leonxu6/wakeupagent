"""Detect sqlite3.enable_callback_tracebacks() global diagnostic changes."""
import argparse
...
def audit_source(s): return [f"sqlite3.enable_callback_tracebacks() mutates process diagnostics on line {c.lineno}" for c in iter_calls(s) if call_name(c)=="sqlite3.enable_callback_tracebacks"]
def audit(root):
