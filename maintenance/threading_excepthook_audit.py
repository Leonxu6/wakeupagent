"""Detect process-wide threading.excepthook replacement."""
import argparse
...
def audit_source(s):
 ...
 for n in iter_assignments(s):
  if "threading.excepthook" in assignment_targets(n):o.append(f"threading.excepthook replacement mutates thread error handling on line {n.lineno}")
 return o
def audit(root):
