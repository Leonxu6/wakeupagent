"""Detect builtin hash() calls whose values are randomized across Python processes."""
...
def audit_source(source: str)->list[str]:
    ...
    return [f"builtin hash() on line {n.lineno}; use a stable digest for persisted identities" for n in ast.walk(tree) if isinstance(n,ast.Call) and isinstance(n.func,ast.Name) and n.func.id=="hash"]
