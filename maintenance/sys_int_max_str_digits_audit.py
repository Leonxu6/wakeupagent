"""Detect sys.set_int_max_str_digits() process-wide safety-limit mutation."""
import argparse
...
def audit_source(s): return [f"sys.set_int_max_str_digits() mutates a process-wide conversion limit on line {c.lineno}" for c in iter_calls(s) if call_name(c)=="sys.set_int_max_str_digits"]
def audit(root):
