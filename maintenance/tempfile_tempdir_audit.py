"""Detect process-wide tempfile.tempdir replacement."""
import argparse
...
def audit_source(s):
 ...
 for n in iter_assignments(s):
  if "tempfile.tempdir" in assignment_targets(n):o.append(f"tempfile.tempdir replacement mutates process temporary-file policy on line {n.lineno}")
 return o
def audit(root):
