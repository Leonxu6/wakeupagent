"""Detect race-prone tempfile.mktemp() calls."""
import argparse, ast
...
def audit_source(source:str)->list[str]:
    ...
    return [f"tempfile.mktemp() on line {n.lineno}" for n in ast.walk(tree) if isinstance(n,ast.Call) and isinstance(n.func,ast.Attribute) and isinstance(n.func.value,ast.Name) and n.func.value.id=="tempfile" and n.func.attr=="mktemp"]
