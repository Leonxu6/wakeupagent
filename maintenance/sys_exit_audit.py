"""Detect sys.exit() in reusable production modules."""
...
def audit_source(source: str)->list[str]:
    ...
    return [f"sys.exit() terminates the hosting process on line {n.lineno}" for n in ast.walk(tree) if isinstance(n,ast.Call) and isinstance(n.func,ast.Attribute) and isinstance(n.func.value,ast.Name) and n.func.value.id=="sys" and n.func.attr=="exit"]
